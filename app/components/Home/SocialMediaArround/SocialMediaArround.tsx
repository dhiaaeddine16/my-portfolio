...
export default function SocialMediaEmail(props: { finishedLoading: any }) {
  return (
    <>
      <motion.div
        initial={{ y: "100%" }}
      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/dhiaaeddine16"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/dhiaa-eddine-dhiaa-eddine-a542b1343/"} />
            {/* Instagram Icon */}
          ...
          >
            {/*<a href="mailto:abdellatif@anaflous.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                dhiaaeddine<span className="text-AAsecondary">@</span>fassi<span className="text-AAsecondary">.</span>com
              </span>
            </a>*/}
          </motion.div>
